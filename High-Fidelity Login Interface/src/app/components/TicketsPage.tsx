...
export function TicketsPage({ onTicketClick }: TicketsPageProps) {
    ...
    <div className={`flex-1 overflow-auto ${isDark ? 'bg-[#0a0a0a]' : 'bg-gray-50'}`}>
      ...
      <div className="p-8">
        ...
        {filteredTickets.length > 0 ? (
          <div onClick={(e) => {
            const ticketElement = (e.target as HTMLElement).closest('[data-ticket-id]');
            if (ticketElement) {
              const ticketId = parseInt(ticketElement.getAttribute('data-ticket-id') || '0');
