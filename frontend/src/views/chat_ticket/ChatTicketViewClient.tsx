        ...
        {messages.map((msg, index) => (
          <div key={index} className="space-y-3">
            <div className="chat chat-end">
              ...
              <div className="chat-bubble chat-bubble-info text-sm md:text-base">{msg.client}</div>
            </div>
            <div className="chat chat-start">
              <div className="chat-image avatar">
                <Avatar src={avatar2} size="sm" />
              </div>
              <div className="chat-bubble text-sm md:text-base">{msg.agent}</div>
            </div>
          </div>
        ))}
      </div>
...
export default ChatTicketViewCliwnt;
